...
# Add footer or header {#add-footer}
***
...
# Add space before title {#add-space}
***
...
# Add caption to your figures {#add-caption}
***
...
# 2 figures in 2 columns {#2columns}
***
...
# Use buttons or tabs for sub-chapters {#buttons .tabset .tabset-fade .tabset-pills}
***
...
Yyour code chunks will be hidden in the output, but a small 'code' button will be available to display it if necessary.
...
# Use interactive graphics {#interactive}
***
...
# Compile several in a website {#website}
***
...
# Feedback
***
This document provides a few tips I often use in my documents. I hope it can help you. If you know any other tip I should add, please send me an email to `paste("yan.holtz.data", "gmail.com", sep=""")`, or suggest it via the [associated github repository](https://github.com/holtzy/Pimp-my-rmd).
